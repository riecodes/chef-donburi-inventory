...
private void generateExpensesReport() {
    ...
    try {
        ...
        try {
            ...
            if (!rs.isBeforeFirst()) {
                System.out.println("No data found in the expenses table.");
            }

            // Create the expenses table with 6 columns (excluding last edited)
            ...
            while (rs.next()) {
                ...
                table.addCell(createCell(itemPrice));
